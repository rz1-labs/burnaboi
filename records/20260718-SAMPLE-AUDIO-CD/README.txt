...
Disc Label:         Sample Audio CD
Date Burned:        2026-07-18
Burned By:          mdrizwanfk

--- Media Info ---
Disc Type:          Audio CD (Red Book)
...
--- Contents Summary ---
 - Burn Mode: Audio CD (Red Book)
 - Audio files selected: 1
 - Non-audio files excluded: 0
 - README.txt and checksums.sha256 stay in the record folder; true audio CDs do not contain disc-root data files.
